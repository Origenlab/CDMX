document.addEventListener('DOMContentLoaded', function() {
      ...
      if (form) {
        form.addEventListener('submit', function(e){
          ...
          var lines = [
            'Hola FIREFIGHTER, vi su perfil en Directorio CDMX y quiero solicitar una cotizacion de EPP industrial.',
            '',
            '* Nombre: ' + nombre,
            '* Telefono: ' + telefono,
          ...
          var msg = lines.join('\n');
          var url = 'https://wa.me/525570081816?text=' + encodeURIComponent(msg);
